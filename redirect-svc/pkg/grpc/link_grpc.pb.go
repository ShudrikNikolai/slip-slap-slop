...
const (
	...
	LinkService_ValidateLink_FullMethodName = "/link.LinkService/ValidateLink"
)
...
func (c *linkServiceClient) ValidateLink(ctx context.Context, in *ValidateLinkRequest, opts ...grpc.CallOption) (*ValidateLinkResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ValidateLinkResponse)
	err := c.cc.Invoke(ctx, LinkService_ValidateLink_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedLinkServiceServer) ValidateLink(context.Context, *ValidateLinkRequest) (*ValidateLinkResponse, error) {
...
func _LinkService_ValidateLink_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ValidateLinkRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LinkServiceServer).ValidateLink(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LinkService_ValidateLink_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LinkServiceServer).ValidateLink(ctx, req.(*ValidateLinkRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var LinkService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _LinkService_ValidateLink_Handler,
		},
	},
