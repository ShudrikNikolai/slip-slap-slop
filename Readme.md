...
Микросервисная архитектура для создания коротких ссылок, редиректов и сбора аналитики(T_T). Состоит из трёх(двух T_T) основных сервисов и вспомогательной инфраструктуры.
...
- **Analytics Service** — сбор и агрегация событий, в процессе разарботки...
